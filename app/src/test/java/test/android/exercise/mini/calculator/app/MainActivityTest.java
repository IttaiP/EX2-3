...
public class MainActivityTest {
  ...
  @Test
  public void when_userClicksButtonDelete_then_activityShouldForwardCallToCalculator_and_ShowTheExpectedCalculatorOutputRightAway() {
    // setup
    String expectedText = "button Delete clicked";
    Mockito.when(mockCalculator.output()).thenReturn(expectedText);

    TextView activityMainTextView = activityUnderTest.findViewById(R.id.textViewCalculatorOutput);
    View buttonDelete = activityUnderTest.findViewById(R.id.buttonBackSpace);
